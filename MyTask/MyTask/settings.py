...
SECRET_KEY = 'django-insecure-^py(mm+!-9n92+h&tn*y9+s03l@8kz_^*4il5cbve!jg%z=d)p'
...
MIDDLEWARE = [
    ...
    'counter.middleware.CountMiddleware',
]
...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'MyTask.exceptions.core_exception_handler',
